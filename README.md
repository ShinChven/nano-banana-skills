...
1. Create a `gem` in the Gemini app.
2. Add this repository URL as `Knowledge`: `https://github.com/ShinChven/nano-banana-skills.git`.
...
| [j-poses](skills/j-poses/SKILL.md) | A library of Japanese style photography poses. |
